...
4. NEXT: SS-2.5 (SS-24) ingestion pipeline (parse corpus -> chunk -> embed 1024 -> store; idempotent, provenance) -> SS-2.6 (SS-23) RAG retrieval (ADR-0001 node) -> SS-2.7 (SS-22) baseline detector that turns the SS-2.3 eval GREEN (4/4 classification + 4/4 evidence). Stage-1: 4 of 7 done (SS-19, SS-20, SS-21, SS-18). Reminder: ingestion/embedding need a self-hostable in-region 1024-dim model (finalise under eval, D1) and a running Postgres+pgvector (Supabase or local) — provisioning that DB is the likely next owner-gated step.
